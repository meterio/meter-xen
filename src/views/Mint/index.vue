    ...
    <v-responsive
      ...
      <div class="px-2">
        <v-row class="text-center">
          <v-col>
            <v-btn :variant="currentStep === 1 ? 'tonal' : 'text'" rounded="pill" @click="clickStep1">Claim Rank</v-btn>
          </v-col>

          <v-col>
            <v-btn :variant="currentStep === 2 ? 'tonal' : 'text'" rounded="pill" @click="clickStep2">Minting</v-btn>
          </v-col>
